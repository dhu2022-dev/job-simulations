# JPMC Trading Dashboard - Perspective

**Status**: ✅ Completed

This project represents completion of a JPMC Software Engineering virtual experience program designed by **J.P. Morgan Chase & Co.** and hosted on Forage. Focused on building trading dashboards with real-time stock price data using JPMC's Perspective framework.

## Program Overview

This virtual experience program simulates how engineers at JPMC use live data to support trading decisions. The program consists of tasks focused on real-time data feeds, financial data visualization, and full-stack integration.

**Note**: Tasks are maintained in separate forked repositories to preserve the original project structure.
...
*Note: This project has been completed. Tasks are maintained in separate forked repositories to preserve the original project structure and demonstrate participation in the program.*
